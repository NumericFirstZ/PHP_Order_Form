                     ...
                     <form name="add_name" id="add_name">  
                          <div class="table-responsive">  
                               <table class="table table-bordered" id="dynamic_field">  
                                    <tr>  
                                         <td><input type="text" name="product[]" placeholder="Product Name" class="form-control name_list" /></td> 
                                         <!-- <td><input type="text" name="quantity[]" placeholder="Product Quantity" class="form-control name_list" /></td> -->
                                        <td>
